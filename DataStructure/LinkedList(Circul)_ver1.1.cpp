...
hNODE* CreateCirLinkL(void);//리스트 생성
NODE * CreateNode(hNODE * header, NODE * pEnd, int data);//노드 추가
NODE * FindNode(hNODE * Header, NODE * pEnd, int data);//노드 검색
NODE * DelNode(hNODE * Header, NODE * pEnd, int data);//노드 제거
NODE * DeleteCirLinkL(hNODE*& Header, NODE* pEnd);//리스트 삭제
void PrintCirLinkL(hNODE * Header, NODE * pEnd, int count);//리스트 출력
void cPrintCirLinkL(hNODE * header);//노드 개수 출력
...
int main(void) {
	...
	cPrintCirLinkL(Header);//현재 자료 개수
	...
	pEndNODE = DelNode(Header, pEndNODE, 40);//30노드 제거
	PrintCirLinkL(Header, pEndNODE, 1);//리스트 출력
	cPrintCirLinkL(Header);

	pEndNODE=DeleteCirLinkL(Header, pEndNODE);//리스트 제거
	PrintCirLinkL(Header, pEndNODE, 1);//리스트 출력
	cPrintCirLinkL(Header);
